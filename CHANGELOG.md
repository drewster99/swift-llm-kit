...
Releases from 0.0.210 onward are documented on the [GitHub Releases page](https://github.com/drewster99/swift-llm-kit/releases). The entries below are the historical notes for 0.0.14 – 0.0.30, preserved as originally written; versions between 0.0.30 and 0.0.209 are described by their commit messages (`git log 0.0.30..0.0.209`).
